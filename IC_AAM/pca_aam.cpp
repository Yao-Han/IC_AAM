...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	CvMat* pResult = cvCreateMat( count_test, kEigens, CV_32FC1 );
	
	cvProjectPCA( inputData_test, MeanShape_test, tmpEigenVectors, pResult );

	CvMat* pRecon = cvCreateMat( count_test, datasetSize_test, CV_32FC1 );		
	cvBackProjectPCA( pResult, MeanShape_test, tmpEigenVectors, pRecon );		//	app:  pRecon( 105 * 10962 )
